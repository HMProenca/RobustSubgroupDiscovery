...
from RSD.rulelistmodel.categoricalmodel.categoricaltarget import CategoricalTarget
from RSD.rulelistmodel.gaussianmodel.gaussiantarget import GaussianTargets
from RSD.data.attribute.attribute import Attribute
from RSD.data.attribute.nominal_attribute import NominalAttribute
from RSD.data.attribute.numeric_attribute import NumericAttribute
...
class Data:
    ...
    target_model: Literal["gaussian", "categorical"]
    min_support: int
