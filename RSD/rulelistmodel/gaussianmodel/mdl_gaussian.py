...
@author: gathu
"""
from RSD.mdl.mdl_base_codes import log2_gamma_half
from RSD.rulelistmodel.gaussianmodel.gaussianstatistic import GaussianFreeStatistic, GaussianFixedStatistic
...
def gaussian_bayesian_encoding(n: int,variance : float,log_gamma_n: float):
    ...
    log_gamma_n : float
        The appropriate value of the gamma function for a given n value. In the case of the Bayesian encoding
...
def length_rule_free_gaussian(rulelist : classmethod, statistics : classmethod):
    ...
    if any(statistics.variance) == 0 or statistics.usage <= 2:
        ...
        #print('Bayesian all: {} ; bayesian 2: {} ; non optimal : {}'.format(l_bayesian_all,l_bayesian_2,l_nonoptimal_2))
    return codelength
